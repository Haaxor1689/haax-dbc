...
const StringRefSchema = n.int32().transform(
...
const LocalizedStringRef = <T extends string>(key: T) =>
  Object.fromEntries([
...
const ArrayField = <T extends string, S extends n.NilTypeAny, N extends number>(
  key: T,
  schema: S,
  count: N
) =>
...
const DbcSchema = <T extends n.NilRawShape>(schema: T) =>
  n
    .object({
...
const Dbc = {
  ...
  BankBagSlotPrices: DbcSchema({
    id: n.int32(),
    cost: n.int32()
  }),
  CameraShakes: DbcSchema({
    id: n.int32(),
    shakeType: n.uint32(),
    direction: n.uint32(),
    amplitude: n.float(),
  ...
  Cfg_Categories: DbcSchema({
    id: n.int32(),
    region: n.int32(),
    ...LocalizedStringRef('name')
  }),
  Cfg_Configs: DbcSchema({
    id: n.int32(),
    realmType: n.int32(),
    playerKillingAllowed: n.int32(),
    rolePlaying: n.int32()
  }),
  CharacterFacialHairStyles: DbcSchema({
    raceId: n.int32(),
    sexId: n.int32(),
    variationId: n.int32(),
    beardGeoset: n.int32(),
  ...
  CharBaseInfo: DbcSchema({
    raceId: n.uint8(),
    classId: n.uint8()
  }),
  CharHairGeosets: DbcSchema({
    id: n.int32(),
    raceId: n.int32(),
    sexId: n.int32(),
    variationId: n.int32(),
  ...
  CharHairTextures: DbcSchema({
    id: n.int32(),
    raceId: n.int32(),
    sexId: n.int32(),
    ...ArrayField('unknown', n.int32(), 5)
  }),
  CharSections: DbcSchema({
    id: n.int32(),
    raceId: n.int32(),
    sexId: n.int32(),
    baseSection: n.int32(),
  ...
  ChatProfanity: DbcSchema({
    id: n.int32(),
    text: StringRefSchema
  }),
  ChrClasses: DbcSchema({
    id: n.int32(),
    playerClass: n.int32(),
  ...
  CinematicSequences: DbcSchema({
    id: n.int32(),
    soundId: n.int32(),
    ...ArrayField('camera', n.int32(), 8)
  }),
  CreatureDisplayInfo: DbcSchema({
    id: n.int32(),
    modelId: n.int32(),
    soundId: n.int32(),
  ...
  CreatureDisplayInfoExtra: DbcSchema({
    id: n.int32(),
  ...
  CreatureModelData: DbcSchema({
    ...
    collisionWidth: n.int32(),
    collisionHeight: n.float(),
    mountHeight: n.float()
  }),
  CreatureSoundData: DbcSchema({
    id: n.int32(),
    extertionId: n.int32(),
  ...
  CreatureSpellData: DbcSchema({
    id: n.int32(),
    ...ArrayField('spellId', n.int32(), 4),
    ...ArrayField('availability', n.int32(), 4)
  }),
  CreatureType: DbcSchema({
    id: n.int32(),
    ...LocalizedStringRef('name'),
    flags: n.int32()
  }),
  DeathThudLookups: DbcSchema({
    id: n.int32(),
    sizeClass: n.int32(),
  ...
  EmotesText: DbcSchema({
    id: n.int32(),
    name: StringRefSchema,
    emoteId: n.int32(),
    ...ArrayField('text', n.int32(), 16)
  }),
  EmotesTextData: DbcSchema({
    id: n.int32(),
    ...LocalizedStringRef('text')
  }),
  EmotesTextSound: DbcSchema({
    id: n.int32(),
  ...
  FactionGroup: DbcSchema({
    id: n.int32(),
    maskId: n.int32(),
    internalName: StringRefSchema,
    ...LocalizedStringRef('name')
  }),
  FactionTemplate: DbcSchema({
    id: n.int32(),
    faction: n.int32(),
    flags: n.int32(),
    factionGroup: n.int32(),
  ...
  FootstepTerrainLookup: DbcSchema({
    id: n.int32(),
  ...
  GameObjectArtKit: DbcSchema({
    id: n.int32(),
    ...ArrayField('textureVariant', StringRefSchema, 3),
    ...ArrayField('attachModel', StringRefSchema, 4)
  }),
  GameObjectDisplayInfo: DbcSchema({
    id: n.int32(),
    modelName: StringRefSchema,
    standSound: n.int32(),
    openSound: n.int32(),
  ...
  ItemPetFood: DbcSchema({
    id: n.int32(),
    ...LocalizedStringRef('name')
  }),
  ItemRandomProperties: DbcSchema({
    id: n.int32(),
    name: StringRefSchema,
  ...
  ItemSubClassMask: DbcSchema({
    classId: n.int32(),
    mask: n.int32(),
    ...LocalizedStringRef('name')
  }),
  ItemVisualEffects: DbcSchema({
    id: n.int32(),
    model: StringRefSchema
  }),
  ItemVisuals: DbcSchema({
    id: n.int32(),
  ...
  LightSkybox: DbcSchema({
    id: n.int32(),
    name: StringRefSchema
  }),
  LiquidType: DbcSchema({
    id: n.int32(),
    name: StringRefSchema,
    type: n.int32(),
    spellId: n.int32()
  }),
  LoadingScreens: DbcSchema({
    id: n.int32(),
    name: StringRefSchema,
    fileName: StringRefSchema
  }),
  LoadingScreenTaxiSplines: DbcSchema({
    id: n.int32(),
    pathId: n.int32(),
  ...
  NamesProfanity: DbcSchema({
    id: n.int32(),
    name: StringRefSchema
  }),
  NamesReserved: DbcSchema({
    id: n.int32(),
    name: StringRefSchema
  }),
  NPCSounds: DbcSchema({
  ...
  PageTextMaterial: DbcSchema({
    id: n.int32(),
    name: StringRefSchema
  }),
  PaperDollItemFrame: DbcSchema({
    id: n.int32(),
    sortIcon: StringRefSchema,
    slotNumber: n.int32()
  }),
  PetLoyalty: DbcSchema({
    id: n.int32(),
    ...LocalizedStringRef('name')
  }),
  PetPersonality: DbcSchema({
    id: n.int32(),
    ...LocalizedStringRef('name'),
  ...
  Resistances: DbcSchema({
    id: n.int32(),
    flags: n.int32(),
    fizzleSoundId: n.int32(),
    ...LocalizedStringRef('name')
  }),
  ServerMessages: DbcSchema({
    id: n.int32(),
    ...LocalizedStringRef('text')
  }),
  SkillLine: DbcSchema({
  ...
  SkillLineCategory: DbcSchema({
    id: n.int32(),
    ...LocalizedStringRef('name'),
    sortIndex: n.int32()
  }),
  SkillRaceClassInfo: DbcSchema({
    id: n.int32(),
    skillId: n.int32(),
    raceMask: n.int32(),
    classMask: n.int32(),
  ...
  SoundProviderPreferences: DbcSchema({
    id: n.int32(),
  ...
  SoundWaterType: DbcSchema({
    id: n.int32(),
    liquidTypeId: n.int32(),
    fluidSpeed: n.int32(),
    soundId: n.int32()
  }),
  SpamMessages: DbcSchema({
    id: n.int32(),
    text: StringRefSchema
  }),
  Spell: DbcSchema({
    ...
    ...ArrayField('effectRealPointsPerLevel', n.int32(), 3),
  ...
  SpellCastTimes: DbcSchema({
    id: n.int32(),
    base: n.int32(),
    perLevel: n.int32(),
    minimum: n.int32()
  }),
  SpellCategory: DbcSchema({
    id: n.int32(),
    flags: n.int32()
  }),
  SpellChainEffects: DbcSchema({
    id: n.int32(),
  ...
  SpellDispelType: DbcSchema({
    id: n.int32(),
    ...LocalizedStringRef('name'),
    mask: n.int32(),
    immunityPossible: n.int32()
  }),
  SpellDuration: DbcSchema({
    id: n.int32(),
    duration: n.int32(),
    durationPerLevel: n.int32(),
    durationMax: n.int32()
  }),
  SpellEffectCameraShakes: DbcSchema({
    id: n.int32(),
    ...ArrayField('cameraShake', n.int32(), 3)
  }),
  SpellFocusObject: DbcSchema({
    id: n.int32(),
    ...LocalizedStringRef('name')
  }),
  SpellIcon: DbcSchema({
  ...
  SpellItemEnchantment: DbcSchema({
    id: n.int32(),
    ...ArrayField('effect', n.int32(), 3),
  ...
  SpellMechanic: DbcSchema({
    id: n.int32(),
    ...LocalizedStringRef('name')
  }),
  SpellRadius: DbcSchema({
    id: n.int32(),
    radius: n.float(),
    radiusPerLevel: n.int32(),
    radiusMax: n.int32()
  }),
  SpellRange: DbcSchema({
    id: n.int32(),
    rangeMin: n.int32(),
    rangeMax: n.int32(),
    flags: n.int32(),
  ...
  SpellVisualEffectName: DbcSchema({
    id: n.int32(),
    name: StringRefSchema,
    fileName: StringRefSchema,
  ...
  SpellVisualPrecastTransitions: DbcSchema({
    id: n.int32(),
    loadAnimation: StringRefSchema,
    holdAnimation: StringRefSchema
  }),
  Startup_Strings: DbcSchema({
    id: n.int32(),
    name: StringRefSchema,
    ...LocalizedStringRef('string')
  }),
  Stationery: DbcSchema({
    id: n.int32(),
    itemId: n.int32(),
    texture: StringRefSchema,
    flags: n.int32()
  ...
  TerrainTypeSounds: DbcSchema({
    id: n.int32()
  }),
  TransportAnimation: DbcSchema({
    id: n.int32(),
    transportId: n.int32(),
    timeIndex: n.int32(),
    ...Position,
  ...
  WorldSafeLocs: DbcSchema({
    id: n.int32(),
    continentId: n.int32(),
    ...Position,
    ...LocalizedStringRef('name')
  }),
  WorldStateUI: DbcSchema({
    id: n.int32(),
    mapId: n.int32(),
    areaId: n.int32(),
  ...
  WowError_Strings: DbcSchema({
    id: n.int32(),
    errorName: StringRefSchema,
    ...LocalizedStringRef('errorText')
  }),
  ZoneIntroMusicTable: DbcSchema({
    id: n.int32(),
    name: StringRefSchema,
    soundId: n.int32(),
    priority: n.int32(),
